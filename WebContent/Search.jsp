...
<body>
	...
	String campus = request.getParameter("collegeType");
	String major = request.getParameter("area3Combobox");
	String submajor = request.getParameter("area4Combobox");
...
%>
      <header id="menusection">
            ...
            <nav id="menubar">
                <ul id="menulist">
                    <li><a href="main.html" class="menu_link">HOME</a></li>
                    <li><a href="timesetting.jsp" class="menu_link">시간표 신청</a></li>
                    <li><a href="time.jsp" class="menu_link">내 시간표</a></li>
                    <li><a href="login.html" class="menu_link">로그인</a></li>
                    <li><a href="join.html" class="menu_link">회원가입</a></li>
                </ul>
            </nav>
        </center>
        <nav id="main_img">
      ...
      <H1>강의검색</H1>
         ...
         <section class = "tablebox">
            ...
            <tbody>
				...
				<%
						if(str[2].equals(search_text))
						{
				%>
							<tr>
							<td><%= str[5] %></td>
							<td><a onclick="return confirm('추가하시겠습니까?')"><%= str[2] %></a></td>
							<td><%= str[10] %></td>
							<td><%= str[6] %></td>
							<td><%= str[1] %></td>
							<td><%= str[7] %></td>
				...
				<%
						...
						else if(str[9].equals(major) || str[9].equals(submajor))
						{
				%>
							<tr>
							<td><%= str[5] %></td>
            	...
            	<tr>
                	<th colspan="8"><h4>검색 결과 (총 갯수: <%= count %>개)</h4></th>
            	</tr>
            </table>
            </section>
</body>
