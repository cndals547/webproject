...
<body>
	<header id="menusection">
     ...
     <section id="joinus">
     	<center>
     		<img src="image/join_background.png" align="left">
     	<nav id="join_text">
     		<form method="post" action="RegisterAction.jsp">
	            <h1>회원가입</h1><br><hr>
	            <p>학번</p><input type="text" placeholder="Student Number" id="stu_num" name="userID" height="20px"><br>
	            <br><p>비밀번호</p><input type="password" placeholder="Password" id="pw" name="userPassword"><br>
	            <br><hr><br>
	            <input type="submit" value="회원가입" id="submit" class="btn btn-primary form-control"><br><br>
            </form> 
       </nav>  
    	</center>
     </section>
